...
const PROMPT_RECEPCION_COMPRAS = "Objetivo: Guiar al usuario para registrar la recepcion de una compra. Solicitá que cargue la factura en imagen o PDF y pedí fecha, proveedor, transporte, total y faltantes. Confirmá los datos y ejecutá la herramienta correspondiente cuando estén completos.";
